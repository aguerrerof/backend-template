<x-app-layout>
    @section('page_title', 'Proveedores logísticos · Crear')
    ...
    <div class="space-y-6">
        ...
        <x-card>
            <form method="POST" action="{{ route('logistic-providers.store') }}" class="space-y-4">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code')" placeholder="Ej: DHL, FEDEX" required />
                ...
                <div>
                    ...
                    <x-text-input id="api_url" name="api_url" type="text" class="mt-1 block w-full" :value="old('api_url')" placeholder="https://api.proveedor.com/" />
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div>
                        ...
                        <textarea id="credentials" name="credentials" rows="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder='{"api_key": "clave", "secret": "secreto"}'>{{ old('credentials') }}</textarea>
                        <x-input-error :messages="$errors->get('credentials')" class="mt-2" />
                    </div>

                    <div>
                        <x-input-label for="config" value="Configuración (JSON)" />
                        <textarea id="config" name="config" rows="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder='{"sandbox": true, "supports_tracking": true}'>{{ old('config') }}</textarea>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input
                        ...
                        value="1"
                        @checked(old('can_cancel_orders', false))
